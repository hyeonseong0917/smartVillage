...
/*********************************************************
 *하늘상태(SKY) 강수형태(PTY) 을 통한 날씨 판정
 ******************************************************** */
function fn_egov_judge_icon(PTY, SKY) {
	icon = "";
    if (PTY != "0"){
		switch (PTY) {
			case "1": icon = "08"; break; /* 비 */
			case "2": icon = "13"; break; /* 비/눈 */
			case "3": icon = "11"; break; /* 눈 */
			case "4": icon = "07"; break; /* 소나기 */
			case "5": icon = "08"; break; /* 빗방울 */
			case "6": icon = "13"; break; /* 빗방울눈날림 */
			case "7": icon = "11"; break; /* 눈날림 */			
			default: icon = "01";
		}
    }else{
		switch (SKY) {
			case "1": icon = "01"; break; /* 맑음 */
			case "3": icon = "03"; break; /* 구름많음 */
			case "4": icon = "04"; break; /* 흐림 */
			default: icon = "01";
		}    
    }

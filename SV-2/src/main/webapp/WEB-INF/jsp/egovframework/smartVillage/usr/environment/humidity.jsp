...
<div class="topM_box">
	<div class="topM_box_inner">
		...
		<p class="_6 _m02"><a href="javascript:moveTab('humidity')" class="active"><i ></i>습도</a></p>
...
<div class="sub_container">
	<div class="villageMap">
		...
		<c:forEach items="${environmentInfo}" var="environmentInfo" varStatus="status">
			<a class="" href="#none">
				<p id="step_0${status.count}" class="_step_01">
					<span class="arrow_box _step_01">
    ...
    $('.villageMap a p').hover(
        function() {
            ...
            let firstLine = textContent.split('\n')[1];
	         ...
	         let info=[];
        	$.getJSON("${pageContext.request.contextPath}/smartVillage/environment/getChartData.mdo", {tabId:encodeURI('humidity')}, function(json){

...
<div class="topM_box">
	<div class="topM_box_inner">
		...
		<p class="_6 _m02"><a href="javascript:moveTab('ultra_particles')" class="active"><i ></i>초미세먼지</a></p>
		...
		<p class="_6 _m02"><a href="javascript:moveTab('noise_pollution')" class=""><i ></i>소음</a></p>
	</div>
</div>
...
<div class="sub_container">
	<div class="villageMap">
		...
		<c:forEach items="${environmentInfo}" var="environmentInfo" varStatus="status">
			<a class="" href="#none">
				<p id="step_0${status.count}" class="
							<c:choose> 
							<c:when test="${environmentInfo.thingModelAttributeValue ge 0 && environmentInfo.thingModelAttributeValue le 15}">
								_step_01
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 16 && environmentInfo.thingModelAttributeValue le 35}">
								_step_02
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 36 && environmentInfo.thingModelAttributeValue le 75}">
								_step_03
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 76}">
								_step_04
							</c:when>
							</c:choose>">
					<span class="
		...
		<div class="data_step_box ">
			<h4>초미세먼지</h4>
			<ul class="_step">
				<li class="_01"><i></i>좋음<span>(0~15)</span></li>
				<li class="_02"><i></i>보통<span>(16~35)</span></li>
				<li class="_03"><i></i>나쁨<span>(36~75)</span></li>
				<li class="_04"><i></i>위험<span>(76~)</span></li>
			</ul>
		</div>
	</div>
</div>
    ...
    $('.villageMap a p').hover(
        function() {
            ...
            let firstLine = textContent.split('\n')[1];
	         ...
	         let info=[];
        	$.getJSON("${pageContext.request.contextPath}/smartVillage/environment/getChartData.mdo", {tabId:encodeURI('ultra_particles')}, function(json){

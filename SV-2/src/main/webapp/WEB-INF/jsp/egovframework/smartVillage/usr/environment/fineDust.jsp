...
<div class="topM_box">
	<div class="topM_box_inner">
		<p class="_6 _m02"><a href="javascript:moveTab('fine_dust')" class="active"><i ></i>미세먼지</a></p>
...
<div class="sub_container">
	<div class="villageMap">
		...
		<c:forEach items="${environmentInfo}" var="environmentInfo" varStatus="status">
			<a class="" href="#none">
				<p id="step_0${status.count}" class="
							<c:choose> 
							<c:when test="${environmentInfo.thingModelAttributeValue ge 0 && environmentInfo.thingModelAttributeValue le 30}">
								_step_01
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 31 && environmentInfo.thingModelAttributeValue le 80}">
								_step_02
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 81 && environmentInfo.thingModelAttributeValue le 150}">
								_step_03
							</c:when>
							<c:when test="${environmentInfo.thingModelAttributeValue ge 151}">
								_step_04
							</c:when>
							</c:choose>">
					<span class="
		...
		<div class="data_step_box ">
			<h4>미세먼지</h4>
			<ul class="_step">
				<li class="_01"><i></i>좋음<span>(0~30)</span></li>
				<li class="_02"><i></i>보통<span>(31~80)</span></li>
				<li class="_03"><i></i>나쁨<span>(81~150)</span></li>
				<li class="_04"><i></i>위험<span>(151~)</span></li>
			</ul>
		</div>
	</div>
</div>
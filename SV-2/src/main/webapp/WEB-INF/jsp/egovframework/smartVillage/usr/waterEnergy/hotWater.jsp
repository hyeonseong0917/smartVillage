...
<script>
	...
	function drawChart() {
		$.getJSON("${pageContext.request.contextPath}/smartVillage/waterEnergy/getChartData.mdo", {tabId:encodeURI('hotWater')}, function(json){
			var jsonData = json.chartInfo;
			if(jsonData == undefined || jsonData == ""){
				return;
			} else {
				let chartData = [['월', '전년 급탕 사용량', '급탕 사용량' ]];
...
<div class="topM_box">
	<div class="topM_box_inner">
		...
		<p><a href="javascript:moveTab('hotWater')" class="active m_05"><i ></i>급탕</a></p>
	</div>
</div>

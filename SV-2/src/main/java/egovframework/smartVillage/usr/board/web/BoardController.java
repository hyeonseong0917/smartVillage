package egovframework.smartVillage.usr.board.web;
...
private DefaultBeanValidator beanValidator;
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/selectBoardList.mdo")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/selectBoardView.mdo")
	public String selectBoardView(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		...
		return "egovframework/smartVillage/usr/board/boardView";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/addBoardView.mdo")
	public String addBoardView(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();

		model.addAttribute("bbsId", boardVO.getBbsId());
	
		return "egovframework/smartVillage/usr/board/boardForm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/insertBoard.mdo")
	public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
		...
		return "redirect:/smartVillage/board/selectBoardList.mdo?bbsId="+board.getBbsId();
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/addReplyView.mdo")
	public String addReplyView(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		BoardMasterVO vo = new BoardMasterVO();
		...
		return "egovframework/smartVillage/usr/board/boardReplyView";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/insertReplyBoard.mdo")
	public String insertReplyBoard(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
...
//			board.setReplyLc((boardVO.getReplyLc()));
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/updateBoardView.mdo")
	public String updateBoardView(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model)
		...
		model.addAttribute("bbsId", bdvo.getBbsId());
		////-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/updateBoard.mdo")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/smartVillage/board/deleteBoard.mdo")
